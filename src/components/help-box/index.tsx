...
export const HelpBox: React.FC = () => {
  ...
  const customerRoles: string[] = ['Independent User'];
  const tenantRoles: string[] = ['Software Engineer', 'Business Professional', 'Team Lead', 'Business Owner'];
  const addOns: string[] = ['chat', 'notifications', 'file'];
  const applicationName = `Taskify`;
