...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'software-engineer', 'business-professional', 'team-lead'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Calendar', path: '/calendars', entity: 'calendar', service: AccessServiceEnum.PROJECT, icon: FiCalendar },
    { name: 'Task', path: '/tasks', entity: 'task', service: AccessServiceEnum.PROJECT, icon: FiClipboard },
    { name: 'Timesheet', path: '/timesheets', entity: 'timesheet', service: AccessServiceEnum.PROJECT, icon: FiClock },
